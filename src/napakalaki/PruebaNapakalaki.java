...
public class PruebaNapakalaki {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Monsters with a prize that levels up more than 1 "
                + "level: ");
        ...
        System.out.println("Monsters whose bad consequence causes the loss of "
                + "certain treasures, whether they are visible or hidden: ");
